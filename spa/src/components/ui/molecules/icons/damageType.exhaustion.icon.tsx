...
export function ExhaustionDamageIcon(props: SvgIconProps) {
    return (
      <Tooltip title='Exhaustion'>
        <SvgIcon viewBox='0 0 60.964 60.964' {...props}>
          <g>
            <path d="M28.639,4.168C17.696,6.194,10.05,16.3,10.709,27.413c0.012,0.205,0.037,0.398,0.064,0.593
              ...
              C35.502,5.121,32.06,3.535,28.639,4.168z M26.135,31.112c-0.858-0.75-1.774-1.444-2.732-2.083c0.078-0.473,0.107-0.98,0.077-1.527
              ...
              c0.708-1.272,0.314-0.656,1.366-1.729c0.547-0.558,1.322-1.017,2.236-1.391C27.951,22.006,26.946,26.545,26.135,31.112z"/>
            <circle cx="43.627" cy="6.667" r="6.667"/>
          </g>
        </SvgIcon>
      </Tooltip>
    );
