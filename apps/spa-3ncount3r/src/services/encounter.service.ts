...
export async function saveEncounter(accessToken: string, viewModel: EncounterViewModel): Promise<EncounterViewModel> {
...
export async function updateEncounter(accessToken: string, viewModel: EncounterViewModel): Promise<EncounterViewModel> {
